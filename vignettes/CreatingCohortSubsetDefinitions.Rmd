...
We will begin by just populating the dummy OMOP data model with subjects and drug exposure, which will be recognized as ibuprofen exposure.
...
Each of these subjects are exposed to celcoxib.
Some of these subjects are exposed to ibuprofen.
The age of each subjects is also provided.
We also note that there are some subjects who are exposed to ibuprofen twice.
Based on this information, the subset ibuprofen with celcoxib is generated for a few selected individuals if they met the defined criteria above (celcoxib and ibuprofen, age, and last exposure).
